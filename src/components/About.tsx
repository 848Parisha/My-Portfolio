          ...
          >
            ...
            <div className="space-y-4 text-gray-300">
              <p className="text-lg leading-relaxed">
                I thrive on turning ideas into real-world solutions and am always eager to explore new technologies. My mission is to create applications that genuinely help people and to keep growing as a developer and a person.
              </p>
              <p className="text-lg leading-relaxed">
                Outside of coding, I enjoy diving into open-source, learning from the tech community, and sharing what I know to help others on their journeys.
              </p>
            </div>
          </motion.div>
